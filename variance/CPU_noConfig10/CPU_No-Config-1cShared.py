...
OFFSET = 2                                          # This is used if trainings are split into A and B, if A, = 0, if B, = NUM_MODELS
TEMP_FOLDER = 'batch_temp32'                        # The file that model weights will be stored after training before being analyzed
