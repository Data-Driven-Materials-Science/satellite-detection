...
OFFSET = 4                                          # This is used if trainings are split into A and B, if A, = 0, if B, = NUM_MODELS
TEMP_FOLDER = 'batch_temp34'                        # The file that model weights will be stored after training before being analyzed
OUTPUT_FILE = '../CPU_NO_CONFIG_Output-10.txt'     # This is the file that stores precision scores
...
FINAL_MODEL_FOLDER = '../../../../../../../ocean/projects/dmr200021p/sprice/variance/CPU_NO_CONFIG-10/trial1/'
#--------------------------------------------------------------
