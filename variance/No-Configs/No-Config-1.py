...
NUM_ITERATIONS = 4000                               # The total number of training iterations
CHECKPOINT_NUM = 4000                               # This is the number of iterations before a checkpoint is stored
NUM_MODELS = 40                                     # This is the number of models that will be trained from scratch
TEMP_FOLDER = 'batch_temp1'                         # The file that model weights will be stored after training before being analyzed
OUTPUT_FILE = '../NO_CONFIG_Output-0.txt'           # This is the file that stores precision scores
...
FINAL_MODEL_FOLDER = '../../../../../../../ocean/projects/dmr200021p/sprice/variance/NO_CONFIG/trial1/'
#--------------------------------------------------------------
