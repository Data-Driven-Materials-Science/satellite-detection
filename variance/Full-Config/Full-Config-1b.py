...
NUM_MODELS = 20                                     # This is the number of models that will be trained from scratch
OFFSET = NUM_MODELS                                 # This is used if trainings are split into A and B, if A, = 0, if B, = NUM_MODELS
TEMP_FOLDER = 'batch_temp4'                         # The file that model weights will be stored after training before being analyzed
OUTPUT_FILE = '../FULL_CONFIG_Output-0.txt'         # This is the file that stores precision scores
...
FINAL_MODEL_FOLDER = '../../../../../../../ocean/projects/dmr200021p/sprice/variance/FULL_CONFIG/trial1/'
#--------------------------------------------------------------
