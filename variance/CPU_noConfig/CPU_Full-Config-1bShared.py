...
NUM_MODELS = 2                                      # This is the number of models that will be trained from scratch
OFFSET = 3                                          # This is used if trainings are split into A and B, if A, = 0, if B, = NUM_MODELS
TEMP_FOLDER = 'batch_temp20'                        # The file that model weights will be stored after training before being analyzed
