...
TEMP_FOLDER = 'batch_temp6'                         # The file that model weights will be stored after training before being analyzed
OUTPUT_FILE = '../CUDA_Benchmark_Output-0.txt'     # This is the file that stores precision scores
...
FINAL_MODEL_FOLDER = '../../../../../../../ocean/projects/dmr200021p/sprice/variance/CUDA_Benchmark/trial1/'
#--------------------------------------------------------------
