...
NUM_MODELS = 13                                     # This is the number of models that will be trained from scratch
OFFSET = NUM_MODELS                                 # This is used if trainings are split into A and B, if A, = 0, if B, = NUM_MODELS
TEMP_FOLDER = 'batch_temp5'                         # The file that model weights will be stored after training before being analyzed
