...
OFFSET = 10                                          # This is used if trainings are split into A and B, if A, = 0, if B, = NUM_MODELS
TEMP_FOLDER = 'batch_temp11'                         # The file that model weights will be stored after training before being analyzed
OUTPUT_FILE = '../FULL_CONFIG_OUTPUT-2.txt'           # This is the file that stores precision scores
...
FINAL_MODEL_FOLDER = '../../../../../../../ocean/projects/dmr200021p/sprice/variance/FULL_CONFIG2/trial1/'
#--------------------------------------------------------------
